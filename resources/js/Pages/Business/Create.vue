                            ...
                            <div class="space-y-6">
                                ...
                                <div class="pt-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div class="h-40 bg-teraq-bg border-teraq-border border-2 rounded-2xl border-dashed flex flex-col items-center justify-center gap-2 group cursor-pointer hover:border-teraq-primary/30 transition-all">
                                            <div class="p-3 bg-white/5 rounded-xl group-hover:bg-teraq-primary/10 transition-colors">
                                                <Upload class="w-6 h-6 text-teraq-muted group-hover:text-teraq-primary" />
                                            </div>
                                            <span class="text-teraq-muted text-[10px] font-bold uppercase tracking-widest">Upload Hero Image</span>
                                        </div>
                                        <div class="h-40 bg-teraq-bg border-teraq-border border-2 rounded-2xl border-dashed flex flex-col items-center justify-center gap-2 group cursor-pointer hover:border-teraq-primary/30 transition-all">
                                            <div class="p-3 bg-white/5 rounded-xl group-hover:bg-teraq-primary/10 transition-colors">
                                                <ImageIcon class="w-6 h-6 text-teraq-muted group-hover:text-teraq-primary" />
                                            </div>
                                            <span class="text-teraq-muted text-[10px] font-bold uppercase tracking-widest">Upload Logo</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
